...
// ✅ UPDATED - Fixed baseURL, added verifyEmail and resendVerification functions
...
export const loginUser = async (userData) => {
  try {
    ...
    */
    ...
    // ✅ Store email for verification resend on 403
    if (error.status === 403 && error.response?.data?.email) {
