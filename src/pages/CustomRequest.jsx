...
const prefilledDestination =
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 md:px-5 py-6 md:py-10 space-y-8 animate-fade-in">
      ...
      {/* HERO */}
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 p-8 md:p-12 text-white">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="text-white/90 text-lg md:text-xl leading-relaxed">
            Tell AI Tour what you want,
            and our intelligent planner
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 dark:text-white outline-none"
                />
              </div>
        ...
        <div className="lg:sticky lg:top-24 h-fit">
          ...
          <Card className="p-6 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-xl space-y-6">
            ...
            {/* AI CARD */}
            <div className="rounded-3xl overflow-hidden bg-gradient-to-br from-blue-600 to-purple-700 p-6 text-white relative">
