      ...
      <div className="max-w-7xl mx-auto px-6 mb-10">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-4 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
          />
        </div>
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-5">
                  {place.activities.slice(0, 3).map((activity, index) => (
                    <span
                      key={index}
                      className="px-3 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 text-xs font-medium"
                    >
                      {activity}
                    </span>
                  ))}
                ...
                {/* BUTTON */}
                <button className="mt-6 w-full py-3 rounded-2xl bg-gradient-to-r from-emerald-500 to-cyan-500 text-white font-bold hover:scale-[1.02] transition-all duration-300 shadow-lg hover:shadow-emerald-500/30">
                  Explore Destination
                </button>
              </div>
            </div>
