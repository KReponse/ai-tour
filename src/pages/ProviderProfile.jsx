...
const ProviderProfile = () => {
  ...
  const fetchProviderProfile = async () => {
    try {
      ...
      const profileRes = await axios.get(`${API_URL}/provider-profiles/public/${id}`);
      ...
      // ✅ Fetch provider tours
      try {
        const toursRes = await axios.get(`${API_URL}/tours/provider/${id}`);
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="relative h-64 md:h-80 w-full overflow-hidden bg-gradient-to-r from-[#0D9488] to-[#F59E0B]">
        {profile.coverImage && (
          <img
            src={`${API_URL}/uploads/${profile.coverImage}`}
            alt="Cover"
            ...
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 sticky top-24">
              ...
              <div className="mt-6 space-y-3">
                ...
                >
                  ...
                  View All Tours ({profile.totalTours || 0})
                </button>
              </div>
            </div>
