      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-lg p-6 border border-gray-100 dark:border-gray-800">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="px-5 py-2.5 rounded-xl bg-[#0D9488] text-white text-sm font-medium hover:bg-[#0f766e] transition flex-shrink-0"
          >
            Contact
          </button>
        </div>
              ...
              <>
                ...
                <div className="p-6 space-y-3">
                  {publicProfile.email && (
                    ...
                    >
                      ...
                      <span className="text-[#374151] dark:text-white group-hover:text-[#0D9488] transition">
                        {publicProfile.email}
                      </span>
                    </a>
                  )}
                ...
                <div className="px-6 pb-2">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                      ...
                      <p className="text-xs text-gray-500">Active Tours</p>
                    </div>
                    <div className="p-3 rounded-xl bg-gray-50 dark:bg-gray-800 text-center">
                ...
                <div className="p-6 border-t border-gray-200 dark:border-gray-800 flex gap-3">
                  <button
                    ...
                    className="flex-1 py-3 rounded-xl bg-[#0D9488] text-white font-medium hover:bg-[#0f766e] transition"
                  >
                    Contact Provider
                  </button>
                  ...
                  <button
                    onClick={() => {
                      ...
                      navigate(`/providers/${publicProfile._id}`);
                    }}
                    className="flex-1 py-3 rounded-xl border-2 border-[#0D9488] text-[#0D9488] font-medium hover:bg-[#0D9488]/10 transition"
                  >
                    View Profile
                  </button>
                </div>
      ...
      <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-2xl max-w-md w-full p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 mt-1">Max {tour.travelers || 10} travelers</p>
          </div>
