...
const Explore = () => {
  ...
  return (
  <div className="relative w-full max-w-7xl mx-auto px-2 sm:px-3 md:px-4 lg:px-5 space-y-8 sm:space-y-10 md:space-y-12 lg:space-y-14 animate-fade-in pb-20 md:pb-6 overflow-x-hidden">
