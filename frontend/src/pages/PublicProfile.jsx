...
import { getPublicProviderProfile, getPublicProviderTours } from '../services/providerService';
...
const PublicProfile = () => {
  ...
  const fetchTours = async (providerId) => {
    try {
      ...
      const data = await getPublicProviderTours(providerId);
      setTours(data.tours || []);
    } catch (error) {
  ...
  const fetchReviews = async (providerId) => {
    try {
      ...
      const data = await getPublicReviews({ providerId, limit: 10 });
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-10">
        {/* ✅ Use ProviderCard for the profile info section */}
        <ProviderCard 
