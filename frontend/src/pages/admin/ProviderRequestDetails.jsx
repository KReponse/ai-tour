  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
      {isIm ? (
        ...
        <div className="h-16 flex flex-col items-center justify-center bg-[#F59E0B]/10 dark:bg-[#F59E0B]/20">
          <FileText size={24} className="text-[#F59E0B]" />
          <span className="text-[10px] font-bold text-[#B45309] dark:text-[#F59E0B]">{ext}</span>
        </div>
      )}
      <div className="p-3">
        <div className="text-xs font-bold text-[#374151] dark:text-white truncate">{label}</div>
        <div className="flex gap-2 mt-2">
          <a href={url} target="_blank" rel="noopener noreferrer" className="text-xs font-semibold text-[#0D9488] dark:text-[#0D9488] hover:underline flex items-center gap-1">
            <Eye size={10} /> View
          </a>
          <a href={url} download className="text-xs font-semibold text-[#0D9488] dark:text-[#0D9488] hover:underline flex items-center gap-1">
